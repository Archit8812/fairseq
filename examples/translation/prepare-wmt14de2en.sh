...
URLS=(
    ...
    "http://opus.nlpl.eu/download.php?f=EUbookshop/v2/moses/de-en.txt.zip"
    "http://opus.nlpl.eu/download.php?f=DGT/v4/moses/de-en.txt.zip"
)
FILES=(
...
echo "Copying preprocessed train data..."
python process_wmt18.py --left $tmp/train.tags.$lang.tok.$src --right $tmp/train.tags.$lang.tok.$tgt < $orig/$WMT18
for l in $src $tgt; do
    for f in "${CORPORA_MOSES[@]}"; do
